...
export default function Contact() {
    ...
    return (
        <section id="contact" className="flex flex-col justify-center items-center main--section py-20 px-32 relative text-black dark:text-white  bg-secondary transition dark:bg-gray-800">
            {/* Background Elements */}
            ...
            <h3 className="font-nunito font-black text-xl tracking-wider text-center relative ml-20">
                <span className="absolute left-1/2 ml-1 -translate-x-48 -top-1 text-white">
                    <svg className="absolute fill-primary" width="106" height="36" viewBox="0 0 106 36" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <span className="absolute top-1 left-7">send</span>
