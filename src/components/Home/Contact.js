...
export default function Contact() {
    ...
    return (
        <section id="contact" className="flex flex-col justify-center items-center main--section py-20 px-32 relative text-black dark:text-white  bg-white dark:bg-gray-800">
            {/* Background Elements */}
